...
<body style="overflow-x: hidden;">
	<div class="colorcontainer">
		<img src="img/resultcha.gif" class="resultcha"><br>
		<br>
		<br>
		<br>
		<br>
		...
		<div class="colorimg">
			<%
				...
				case "0":
			%>
			<img class="mood" src="test/0.jpg">
			<%
				break;
				case "1":
			%>
			<img class="mood" src="test/1.jpg">
			<%
				break;
				case "2":
			%>
			<img class="mood" src="test/2.jpg">
			<%
				break;
				case "3":
			%>
			<img class="mood" src="test/3.jpg">
			<%
				break;
				case "4":
			%>
			<img class="mood" src="test/4.jpg">
			<%
				break;
				default:
			%>
			...
			<%
				...
				case "0":
			%>
			<img class="nature" src="test/0.jpg">
			<%
				break;
				case "1":
			%>
			<img class="nature" src="test/1.jpg">
			<%
				break;
				case "2":
			%>
			<img class="nature" src="test/2.jpg">
			<%
				break;
				case "3":
			%>
			<img class="nature" src="test/3.jpg">
			<%
				break;
				case "4":
			%>
			<img class="nature" src="test/4.jpg">
			<%
				break;
				default:
			%>
			...
			<%
				...
				case "0":
			%>
			<img class="character" src="test/0.jpg">
			<%
				break;
				case "1":
			%>
			<img class="character" src="test/1.jpg">
			<%
				break;
				case "2":
			%>
			<img class="character" src="test/2.jpg">
			<%
				break;
				case "3":
			%>
			<img class="character" src="test/3.jpg">
			<%
				break;
				case "4":
			%>
			<img class="character" src="test/4.jpg">
			<%
				break;
				default:
			%>
